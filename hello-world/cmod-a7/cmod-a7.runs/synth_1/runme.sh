...
HD_PWD='C:/Users/rafcal0v/riscv-steel-tests/hello-world/cmod-a7/cmod-a7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_world_cmod_a7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hello_world_cmod_a7.tcl
