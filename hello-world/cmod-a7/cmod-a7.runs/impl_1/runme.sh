...
HD_PWD='C:/Users/rafcal0v/riscv-steel-tests/hello-world/cmod-a7/cmod-a7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hello_world_cmod_a7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hello_world_cmod_a7.tcl -notrace
